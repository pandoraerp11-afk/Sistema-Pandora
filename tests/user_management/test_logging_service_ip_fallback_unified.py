"""Teste unificado: fallback de IP no logging de atividade.

Substitui variantes duplicadas 'test_logging_service_ip_fallback.py' que causavam
'import file mismatch'. Manter este nome exclusivo até limparmos caches no CI.
"""
...
def test_log_activity_ip_fallback() -> None:
    user_model = get_user_model()
    u = user_model.objects.create_user(username="u1", password="x")
    # Sem IP explícito
