"""Utilitários de teste para dirigir o wizard de criação de Tenant.

Este módulo provê a classe `TenantWizardTestHelper`, que encapsula chamadas ao
wizard multi-step de criação de empresa (Tenant) em testes de integração.
"""
...
class TenantWizardTestHelper:
    ...
    def __init__(self, client: Client) -> None:
        """Inicializa o helper com uma instância de `django.test.Client`."""
        self.client = client
