...
class Evento(models.Model):
    ...
    local = models.CharField(max_length=255, blank=True, null=True, verbose_name="Local")
    ...
    tipo_evento = models.CharField(
        max_length=20, choices=TIPO_EVENTO_CHOICES, default="outro", verbose_name="Tipo de Evento"
    )
    ...
    participantes = models.ManyToManyField(
        settings.AUTH_USER_MODEL, blank=True, related_name="agenda_eventos_participante", verbose_name="Participantes"
    )
    ...
    def save(self, *args, **kwargs):  # Garantir uuid e ajustar status compatível
    ...
    # -------------------------
    @property
    def tipo(self):  # type: ignore
        return self.tipo_evento

    @tipo.setter
    def tipo(self, value):  # type: ignore
